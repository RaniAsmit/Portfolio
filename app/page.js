      ...
      <div className="max-w-4xl mx-auto space-y-16">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Full-stack dev who builds APIs that behave and UIs that don’t hurt.
            Currently crafting scalable systems with Spring Boot, Flutter, and MongoDB—while teaching AI to do some of the work.
          </p>
        </motion.section>
